...
> **作者**：駱昊
>
> **說明**：如果上 GitHub 好慢嘅話，可以留意我嘅知乎號（[**Python-Jack**](https://www.zhihu.com/people/jackfrued)），上面嘅[「**由零開始學Python**」](<https://zhuanlan.zhihu.com/c_1216656665569013760>)專欄（對應呢個項目頭20日嘅內容）比較啱初學者，其他嘅專欄好似「[**數據思維同統計思維**](https://www.zhihu.com/column/c_1620074540456964096)」、「[**基於Python嘅數據分析**](https://www.zhihu.com/column/c_1217746527315496960)」、「[**話走就走嘅AI之旅**](https://www.zhihu.com/column/c_1628900668109946880)」等都仲繼續寫緊同更新緊，歡迎大家關注、讚好同留言。如果想免費學習打卡或者參與問題討論，可以加入下面嘅QQ交流群（三個群揀一個加就得），唔好重複加群，亦都唔好喺群度發廣告同其他色情、低俗或者敏感內容。如果需要付費學習或付費諮詢，可以加我私人微信（微訊號：**jackfrued**），備註好自己嘅稱呼同需求，我會為大家提供力所能及嘅幫助。
>
> <img src="res/python_study_qq_group.png" style="zoom:30%;">
>
> 呢個項目對應嘅部分影片已經同步到 [Bilibili](https://space.bilibili.com/1177252794)，有興趣嘅小伙伴可以讚好、投幣、關注，一鍵三連支持吓！

### Python應用領域同職業發展分析

簡單嚟講，Python係一個「優雅」、「明確」、「簡單」嘅程式語言。
...
Python喺以下領域都有用武之地。
 ...
 - 機械學習 - Python / R / C++ / Julia
 - 自動化測試 - Python / Shell

作為一名Python開發人員，根據個人喜好同職業規劃，可以選擇嘅就業領域都非常多。

- Python後端開發工程師（伺服器、雲平台、數據接口）
- Python運維工程師（自動化運維、SRE、DevOps）
- Python數據分析師（數據分析、商業智能、數字化營運）
- Python數據科學家（機械學習、深度學習、算法專家）
- Python爬蟲工程師（唔建議呢條路！！！）
- Python測試工程師（自動化測試、測試開發）

> **說明**：而家，**數據科學呢條路係非常熱門嘅方向**，因為無論係互聯網行業定傳統行業都已經積累咗大量嘅數據，各行各業都需要數據科學家由現有嘅數據中發掘更多嘅商業價值，從而為企業嘅決策提供數據嘅支持，呢個就係所謂嘅數據驅動決策。

畀初學者嘅幾個建議：

- **Make English as your working language.** （等英文成為你嘅工作語言）
- **Practice makes perfect.** （熟能生巧）
- **All experience comes from the mistakes you've made.** （所有經驗都係嚟自你犯過嘅錯）
- **Don't be a freeloader.** （唔好做伸手黨）
- **Either outstanding or out.** （一係出眾，一係出局）
...
#### Day02 - [第一個Python程序](./Day01-20/02.第一个Python程序.md)

1. 編寫代碼嘅工具
2. 你好世界
3. 註釋你嘅代碼

#### Day03 - [Python語言中嘅變數](./Day01-20/03.Python语言中的变量.md)
...
#### Day04 - [Python語言中嘅運算符](./Day01-20/04.Python语言中的运算符.md)
...
#### Day05 - [分支結構](./Day01-20/05.分支结构.md)
...
#### Day06 - [循環結構](./Day01-20/06.循环结构.md)
...
#### Day07 - [分支同循環結構實戰](./Day01-20/07.分支和循环结构实战.md)
...
#### Day08 - [常用數據結構之列表-1](./Day01-20/08.常用数据结构之列表-1.md)

1. 創建列表
2. 列表嘅運算
3. 元素嘅遍歷

#### Day09 - [常用數據結構之列表-2](./Day01-20/09.常用数据结构之列表-2.md)
...
#### Day10 - [常用數據結構之元組](./Day01-20/10.常用数据结构之元组.md)
...
#### Day11 - [常用數據結構之字符串](./Day01-20/11.常用数据结构之字符串.md)
...
#### Day12 - [常用數據結構之集合](./Day01-20/12.常用数据结构之集合.md)
...
#### Day13 - [常用數據結構之字典](./Day01-20/13.常用数据结构之字典.md)
...
#### Day14 - [函數同模組](./Day01-20/14.函数和模块.md)
...
#### Day15 - [函數應用實戰](./Day01-20/15.函数应用实战.md)
...
#### Day16 - [函數使用進階](./Day01-20/16.函数使用进阶.md)
...
#### Day23 - [Python讀寫CSV文件](./Day21-30/23.Python读写CSV文件.md)
...
#### [Python語言進階](./Day31-35/31.Python语言进阶.md)
...
#### [Web前端入門](./Day31-35/32-33.Web前端入门.md)
...
#### [玩轉Linux操作系統](./Day31-35/34-35.玩转Linux操作系统.md)
